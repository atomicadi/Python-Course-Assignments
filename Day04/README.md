...
In this file a liitle modification is added, that is "Temperature checker" (TC). TC will check the digit given by user and then do a short unit conversion to convert any temperature in Kelvin using unit conversion formula.
